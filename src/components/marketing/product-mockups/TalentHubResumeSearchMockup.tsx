/** TalentHub resume search & shortlist UI collage — detailed */
export function TalentHubResumeSearchMockup({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 440 320"
      fill="none"
    ...
    >
      ...
      <text x="200" y="34" textAnchor="middle" fontSize="11" fontWeight="600" fill="#64748b">
        Ellure TalentHub · Resume search
      </text>
      ...
      {["Dashboard", "Resume search", "Shortlists", "Jobs", "Clients"].map((label, i) => (
        <g key={label}>
          ...
          />
          <text x="28" y={105 + i * 32} fontSize="9" fill={i === 1 ? "#0566CD" : "#475569"}>
            {label}
          </text>
        </g>
      ))}
      ...
      <text x="124" y="82" fontSize="14" fontWeight="700" fill="#010c7d">
        Resume search
      </text>
      ...
      <rect x="334" y="94" width="78" height="28" rx="14" fill="#0566CD" />
      ...
      {[0, 1, 2].map((i) => (
        <g key={i}>
          ...
          <rect x="360" y={176 + i * 52} width="40" height="20" rx="10" fill={i === 0 ? "#1A9EB0" : "#e2e8f0"} />
          <text
            x={368}
            y={190 + i * 52}
            fontSize="9"
      ...
      <rect x="300" y="24" width="120" height="36" rx="12" fill="#1A9EB0" filter="url(#shadow)" />
