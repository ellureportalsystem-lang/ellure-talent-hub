/** NexHire client workspace — detailed jobs, shortlists, messages */
export function NexHireClientWorkspaceMockup({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 440 320"
      fill="none"
    ...
    >
      ...
      <text x="28" y="34" fontSize="12" fontWeight="700" fill="#9a3412">
        Ellure NexHire · Client workspace
      </text>
      ...
      <text x="140" y="80" fontSize="12" fontWeight="700" fill="#1e40af">
        Senior Product Designer
      </text>
      <rect x="140" y="88" width="80" height="20" rx="10" fill="#dbeafe" />
      <text x="150" y="102" fontSize="9" fill="#2563eb">
        12 in pipeline
      </text>
      ...
      <rect x="324" y="56" width="104" height="148" rx="12" fill="#2563eb" />
      ...
      {[0, 1, 2, 3, 4].map((i) => (
        <circle key={i} cx={150 + i * 36} cy={268} r="14" fill={["#93c5fd", "#fda4af", "#86efac", "#fcd34d", "#c4b5fd"][i]} />
      ))}
      <rect x="300" y="252" width="108" height="28" rx="14" fill="#0d9488" />
